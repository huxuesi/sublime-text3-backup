        ...
        <Card v-if="type == 'posts'" v-for="list in feedlist" :key="list.pid" class="feedlistcard" :bordered="!dishover" :dis-hover="dishover">
            <div class="clearfix feedlist">
                <div class="lhead">
                    ...
                    <div class="zhiwei">
                        <span>{{$authCodeT(list.vip).isLawyer ? $authCodeT(list.vip).role : list.job}}</span>
                    </div>
                </div>
                <div class="linfo">
                    <div class="tit">
                        <a @click.prevent="$router.push({ name: 'postRead', params: { read_pid: list.pid}})" :href="`/post/read/${list.pid}`" :title="list.title">{{list.title}}</a>
                        <div class="titright">
                            <div class="iconwrap">
                    ...
                    <div :class="{ haveimg: list.thumb}" class="deswrap">
                        ...
                        <div
                            v-if="list.thumb"
                            class="desimg"
                            :style="{backgroundImage: `url(${list.thumb})`}">
                        </div>
                        <div @click="$router.push({ name: 'postRead', params: { read_pid: list.pid}})" class="des">
                            <!-- @click="$router.push({ name: 'postRead', params: { read_pid: list.pid}})" -->
                            <div class="content ellipsis2 text-content" v-html="trimspace(list.summary)"></div>
        ...
        <Card v-if="type == 'bestPost'" v-for="list in feedlist" :key="list.pid" class="feedlistcard" :bordered="!dishover" :dis-hover="dishover">
            <div class="clearfix feedlist">
                <div class="lhead">
                    ...
                    <div class="zhiwei">
                        <span>{{$authCodeT(list.vip).isLawyer ? $authCodeT(list.vip).role : list.userJob}}</span>
                    </div>
                </div>
                <div class="linfo">
                    <div class="tit">
