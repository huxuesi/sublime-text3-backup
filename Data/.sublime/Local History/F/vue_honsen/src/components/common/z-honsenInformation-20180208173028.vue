    ...
    <div class="z-honsenInformation">
        ...
        <Tabs class="body" :value="curTag">
            <TabPane label="用户指引" name="guide">
                <div class="item" v-for="(post,index) in guides" :key="index" @click="toPost(post.pid)">
                    <!-- <img class="img" :src="post.thumb? post.thumb: '/static/img/loginpost.png'"> -->
            ...
            <TabPane label="精品知识" name="bestPost">
                <div class="item" v-for="(post,index) in bestPosts" :key="index" @click="toPost(post.pid)">
                    <!-- <img class="img" :src="post.thumb? post.thumb: '/static/img/loginpost.png'"> -->
        ...
        <div class="left_btn" @click="curTag = 'guide'"><Icon type="ios-arrow-back"></Icon></div>
        <div class="right_btn" @click="curTag = 'bestPost'"><Icon type="ios-arrow-forward"></Icon></div>
    </div>
</template>
