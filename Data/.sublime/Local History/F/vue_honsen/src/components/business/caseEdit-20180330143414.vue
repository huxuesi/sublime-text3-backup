...
<template>
    <div class="caseeditv2">
        ...
        <div class="caseeditmiddlewrap">
            ...
            <div class="middleconnonnavwrap floatpanel">
                <div class="head">
                    <span class="tit">案件跟进</span>
                    <span v-if="0" class="edit"><Button type="ghost" size="large">添 加</Button></span>
                    <span v-else class="edit">
                        <Dropdown @on-click="casekeepmenuClick">
                            <Button type="ghost" size="large">保 存</Button>
                            <DropdownMenu slot="list">
                                <DropdownItem name="allfiles">取 消</DropdownItem>
                            </DropdownMenu>
                        </Dropdown>
                    </span>
                </div>
