...
<template>
    <div class="businesslistwrapv3">
        ...
        <Modal
            ...
            <div class="modal_tit tag_tit casecreateformselecttit">新建案件</div>
            <Form :model="casecreateform" :rules="ruleValidate" ref="casecreateform" :label-width="120" class="casecreateform">
                ...
                <Row>
                    ...
                    <Col span="2" class="newctmaddwrap" v-clickoutside="">
                        <div class="newctmaddicon">
                            <Icon @click.native="toAddNewCTM" type="android-add-circle" title="添加客户"></Icon>
                        </div>
                        <!-- <div v-if="1" class="floatpanel newctmaddpanel">
                            <p class="newctmaddpaneltitle">添加客户</p>
                            <Input @on-enter="" v-model.trim="addNewCtmVal" ref="addnewctmipt" placeholder="输入客户名称"></Input>
