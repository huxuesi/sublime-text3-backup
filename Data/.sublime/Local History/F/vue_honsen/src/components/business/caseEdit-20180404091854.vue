                ...
                <div class="head">
                    ...
                    <span v-if="1" class="edit">
                        ...
                        <Upload
                            ...
                            ref="up_load_ref"
                            name="upload">
                            <Button class="up_btn" type="info">上 传</Button>
                        </Upload>
                    </span>
                </div>
            ...
            <div class="caseeditbottomcenter clearfix">
                <div v-for="(flow, index) in aFlows" class="caseeditbottomitemgroup clearfix">
                    ...
                    <div @click="toogleCurflow(flow)" :class="{active: flow.casefid == curflowid}" class="caseeditbottomitem">
                        ...
                        <div class="con">
                            <span :style="{backgroundColor: bgColorArr[index % bgColorArr.length]}" class="topleftcorner"></span><img v-if="index == 0" src="/static/icon/bizinfo_caseindex_thumb.png" class="thumbimg"><img v-else src="/static/icon/bizinfo_caseflow_thumb.png" class="thumbimg">
                        </div>
                    </div>
                    <!-- 子流程 -->
                    <div @click="toogleCurflow(subflow)" v-for="(subflow, subindex) in flow.sub_fids" :class="{active: subflow.casefid == curflowid}" class="caseeditbottomitem">
                        ...
                        <div class="con">
                            <span :style="{background: bgColorArr[index % bgColorArr.length]}" class="topleftcorner"></span><img v-if="0" src="/static/icon/bizinfo_caseindex_thumb.png" class="thumbimg"><img v-else src="/static/icon/bizinfo_caseflow_thumb.png" class="thumbimg">
                        </div>
                    </div>
                </div>
...
export default {
    ...
    data() {
        return {
            ...
            canEdit: false,
            caseInfo: {},
            bgColorArr: ['transparent', '#00a0e9', '#9756b7', '#13b5b1'],
            aFlows: [],
            curflowid: -1,
            caseloading: false,
