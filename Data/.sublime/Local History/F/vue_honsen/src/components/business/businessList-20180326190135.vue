    ...
    <div class="businesslistwrapv3">
        ...
        <Modal
            ...
            <div class="authsettingitem authsettingedit">
                <div class="itemtitle">协作者 <Icon type="android-add-circle"></Icon></div>
                <div class="itemwrap">
                    <div class="nodatalist" style="padding: 26px 0;">还未添加协作者...</div>
                </div>
            </div>
            <div class="authsettingitem authsettingread">
                <div class="itemtitle">外访者 <Icon type="android-add-circle"></Icon></div>
                <div class="itemwrap">
                    <div class="nodatalist" style="padding: 26px 0;">还未添加外访者...</div>
                </div>
            </div>
            <div v-if="1" class="commonselectsomethingwrapv2 casecreateformtplvalselect floatpanel">
                <div class="toptit">添加编辑权限</div>
                <div class="topnav">
                    <a @click="caseModalTplNav = 'gr'" :class="{nohover : caseModalTplNav == 'gg'}" href="javascript:;">最近联系人</a>
                    <a @click="caseModalTplNav = 'gg'" :class="{nohover : caseModalTplNav == 'gr'}" href="javascript:;">我的关注</a>
                </div>
                <div v-if="caseModalTplNav != 'gr'" class="contactlist">
                </div>
                <div v-if="caseModalTplNav != 'gg'" class="myfollowlist">
                    <Collapse class="myfollowlistcol" accordion>
                        <Panel v-for="n in 10" :key="n">
                            <span class="listname">呵呵呵呵呵呵</span>
                            <span @click.stop class="allcheckbtnwrap" title="全选此分组">
                                <Checkbox @click.native.stop=""></Checkbox>
                            </span>
                            <div slot="content">
                                <CheckboxGroup>
                                    <Checkbox
...
export default {
    ...
    components: { pay, InfiniteLoading},
