...
.businesslistwrapv3
    ...
    .bizlistwrapv3
        ...
        .cusname, .cuslistname
            width: 244px
            justify-content: flex-start
        .creatname, .creatlistname, .state, .statelist, .time, .timelist
            width: 120px
        ...
        <div class="bizlistwrapv3">
            <div class="bizwrap">
                <div class="bizlisthead clearboth">
                    ...
                    <div class="headitem cusname"><div class="cursorwrap">客户名称<div class="triangleiconwrap"><span class="triangleicondown"></span></div></div></div>
                    <div class="headitem creatname"><div class="cursorwrap">创建者<div class="triangleiconwrap"><span class="triangleicondown"></span></div></div></div>
                    <div class="headitem belongname"><div class="cursorwrap">归属者<div class="triangleiconwrap"><span class="triangleicondown"></span></div></div></div>
                    <div class="headitem state"><div class="cursorwrap">处理状态<div class="triangleiconwrap"><span class="triangleicondown"></span></div></div></div>
                ...
                <div class="bizlistbody">
                    <div v-for="n in 10" class="bizlistbodyitem">
                        <div class="listitem caselistname"><a href="javascript:;" style="color: #0050b3;">投资合同协议书</a></div>
                        <div class="listitem cuslistname">投资合同协议书</div>
                        <div class="listitem creatlistname"><img src="/static/icon/cusgrayhead.png"></div>
                        <div class="listitem belonglistname">互选啊</div>
                        ...
                        <div class="listitem editlist">
                            <Dropdown @on-click="" class="dropdown" placement="bottom-end">
                                <a href="javascript:;">
            ...
            <div class="cuswrap">
                <div class="bizlisthead clearboth">
                    <div class="headitem cusname">客户名称</div>
                    <div class="headitem creatname"><div class="cursorwrap">创建者<div class="triangleiconwrap"><span class="triangleicondown"></span></div></div></div>
                    <div class="headitem etime"><div class="cursorwrap">创建时间<div class="triangleiconwrap twoitems"><span class="triangleicontop gray"></span><span class="triangleicondown"></span></div></div></div>
                    <div class="headitem time"><div class="cursorwrap">案件数量<div class="triangleiconwrap twoitems"><span class="triangleicontop"></span><span class="triangleicondown gray"></span></div></div></div>
                    <div class="headitem edit">操作</div>
                </div>
                <div class="bizlistbody">
                    <div v-for="n in 10" class="bizlistbodyitem">
                        ...
                        <div class="listitem belonglistname">互选啊</div>
                        <div class="listitem etimelist">17-78-78</div>
                        <div class="listitem timelist">10</div>
                        <div class="listitem editlist">
                            <Dropdown @on-click="" class="dropdown" placement="bottom-end">
                                <a href="javascript:;">
                                    <Icon class="editicon" type="android-more-vertical"></Icon>
