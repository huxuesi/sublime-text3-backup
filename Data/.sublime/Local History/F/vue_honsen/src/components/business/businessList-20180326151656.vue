        ...
        <div class="bizlistwrapv3">
            ...
            <div v-else class="cuswrap">
                <div class="bizlisthead clearboth">
                    ...
                    <div class="headitem cusetime"><div class="cursorwrap">创建时间<div class="triangleiconwrap twoitems"><span :class="{gray: bizsortdata.cusaddtimesort}" class="triangleicontop"></span><span :class="{gray: !bizsortdata.cusaddtimesort}" class="triangleicondown"></span></div></div></div>
                    <div class="headitem cuscasename"><div class="cursorwrap">案件数量<div class="triangleiconwrap twoitems"><span :class="{gray: bizsortdata.casenum}" class="triangleicontop"></span><span :class="{gray: !bizsortdata.casenum}" class="triangleicondown"></span></div></div></div>
                    <div class="headitem edit">操作</div>
                </div>
                <div class="bizlistbody">
                    <!-- <transition-group name="grouplist2" tag="div"> -->
