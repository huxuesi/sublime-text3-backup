        ...
        <div class="caseeditbottomwrap">
            <div class="caseeditbottomcenter clearfix">
                <div v-for="(flow, index) in aFlows" class="caseeditbottomitemgroup">
                    <!-- 父流程 -->
                    <div :class="{active: flow.casefid == curflowid}" class="caseeditbottomitem">
                    ...
                    <!-- 子流程 -->
                    <div v-for="(subflow, subindex) in flow.sub_fids" :class="{active: subflow.casefid == curflowid}" class="caseeditbottomitem">
