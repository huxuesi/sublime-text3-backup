    ...
    methods: {
        ...
        toogleCurflow(flow) {
            ...
            if( flow.is_bigflow ){
                ...
                this.$ajax('get', this.$apiConfig.bizGroup.getCaseFlowInfo.replace(/\{ctmid\}/, this.caseInfo.ctmid).replace(/\{caseid\}/, this.caseInfo.caseid), `/biz/flow/${this.caseId}/list/${this.curFlow.casefid}/${this.curParentFlow.casefid}`, data => {
