        ...
        <div class="caseeditmiddlewrap">
            ...
            <div class="middlebottom">
                <div class="middlebottomitem middlebottomitem1">
                    ...
                    <div>
                        <Dropdown placement="top-start" class="dropdown">
                            ...
                            <DropdownMenu slot="list">
                                <DropdownItem name="editctm">所有附件</DropdownItem>
                                <DropdownItem name="delctm">推送流程</DropdownItem>
                                <DropdownItem name="addcase">所有跟进</DropdownItem>
                                <DropdownItem name="setcus">编辑日志</DropdownItem>
                            </DropdownMenu>
                        </Dropdown>
                    </div>
                </div>
