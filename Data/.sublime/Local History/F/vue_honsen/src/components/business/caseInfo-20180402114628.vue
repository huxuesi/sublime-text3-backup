    ...
    <div class="case_infov2">
        ...
        <div class="caseinfoformwrap">
            ...
            <div class="formitem2 contact"><span class="itemtit">联系人：</span>
                <Tag v-for="cts in contacts" closable @on-close="" :key="cts.ctmctctid"  class="commontagwrapv2">{{cts.name}}</Tag>
            </div>
            ...
            <div class="formitem2 xiezuozhe"><span class="itemtit">协作者：</span>
                <Tag v-for="n in 3" closable @on-close="" :key="n"  class="commontagwrapv2">标签一</Tag>
            </div>
