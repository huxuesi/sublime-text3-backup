        ...
        <div v-if="curflowobj.casefid" class="caseeditmiddlewrap">
            ...
            <div v-if="bottomfilesnav" class="middleconnonnavwrap floatpanel">
                <div class="head">
                    ...
                    <span class="edit">
                        <Upload
                            v-if="canEditOwnCreated(this.curflowobj.creator) && !isEntrust"
                ...
                <div class="conwrap clearfix">
                    ...
                    <div class="fujianwrap">
                        ...
                        <ul class="con">
                            <li v-for="(file, index) in this.curflowobj.filesjson">
                                ...
                                <span v-if="canEditOwnCreated(this.curflowobj.creator) && !isEntrust" class="del toggleimgnav"><img class="def" src="/static/icon/bizv2_delicon.png"><img class="hov" src="/static/icon/bizv2_del_icon_.png"></span>
                            </li>
                        </ul>
                    </div>
                </div>
