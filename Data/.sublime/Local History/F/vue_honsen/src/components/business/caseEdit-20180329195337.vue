...
<template>
    <div class="caseeditv2">
        ...
        <div class="caseeditmiddlewrap">
            ...
            <div class="middlecasekeepwrap floatpanel">
                <div class="head">
                    <span class="tit">案件跟进</span>
                    <span class="edit"><Button type="ghost" size="large">添 加</Button></span>
                </div>
                <div class="conwrap">
                    <div class="casekeepwrap">
                         <!-- :label-width="" -->
                        <Form :model="casekeepcreateform" :rules="ruleValidate" ref="casekeepcreateform" class="casecreateform cuscreateform">
