...
<template>
    <div class="case_infov2">
        <div class="commoncaseinfohead caseinfohead">
            ...
            <div>
                <span class="item author">创建者：{{caseInfo.belong && caseInfo.belong.name}}</span>
                <span class="edit"><Button @click.native="toEditCaseInfo" type="ghost">编 辑</Button></span>
            </div>
        </div>
        <div class="caseinfoformwrap">
            ...
            <div class="formitem2 contact"><span class="itemtit">联系人：</span>
                <span v-if="index < 3" v-for="(cts, index) in contacts">
                    <Tag closable @on-close=""  class="commontagwrapv2">{{cts.name}}</Tag>
                </span>
