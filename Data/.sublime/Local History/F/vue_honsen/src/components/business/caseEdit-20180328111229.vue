                ...
                <div class="wrap1150">
                    <div class="caseinfowrap">
                        ...
                        <div class="caseinfoformwrap">
                            <div class="formitem ctmname">客户名称：弘商信息技术（深圳）有限公司</div>
                            <div class="formitem contact">联系人：132132132</div>
                            <div class="formitem casename">案件名称：案件名称案件名称名称</div>
                            <div class="formitem xiezuozhe">协作者：221121221</div>
                            <div class="formitem ctmbelong">客户归属：胡小燕</div>
                            <div class="formitem outvisiter">外访者：132132132132132</div>
                        </div>
                    </div>
                </div>
            </div>
