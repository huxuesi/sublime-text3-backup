            ...
            <div v-else class="cuswrap">
                ...
                <div class="bizlistbody">
                    <div v-for="cuslist in customerlist" class="bizlistbodyitem">
                        <div class="listitem cuscuslistname"><a href="javascript:;" class="single_ellipsis">{{cuslist.name}}</a></div>
                        <div class="listitem cusbelonglistname"><a href="javascript:;" class="single_ellipsis">{{cuslist.creatorname}}</a></div>
    ...
    methods: {
        ...
        onInfiniteLoading($state) {
            ...
            if( this.curBigBigNav == 'cus' ){
                this.getCustomerList($state, this.customerlist);
            }
        }
    },
    filters: {
