    ...
    <div class="case_infov2">
        ...
        <div class="caseinfoformwrap">
            ...
            <div class="formitem2 contact"><span class="itemtit">联系人：</span>
                ...
                <Icon @click.native="openAddmember('contacts')" type="android-add-circle" :class="{hover: 0}" class="addnewiconv2"></Icon>
            </div>
            ...
            <div class="formitem2 xiezuozhe"><span class="itemtit">协作者：</span>
                ...
                <Icon @click.native="openAddmember('coactors')" type="android-add-circle" :class="{hover: 0}" class="addnewiconv2"></Icon>
            </div>
            ...
            <div class="formitem2 outvisiter"><span class="itemtit">外访者：</span>
                ...
                <Icon @click.native="openAddmember('visitors')" type="android-add-circle" :class="{hover: 0}" class="addnewiconv2"></Icon>
            </div>
        </div>
