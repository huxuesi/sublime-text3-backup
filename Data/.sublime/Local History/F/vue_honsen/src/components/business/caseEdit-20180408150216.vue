            ...
            <div class="caseeditbottomcenter clearfix">
                <div v-for="(flow, index) in aFlows" class="caseeditbottomitemgroup clearfix">
                    ...
                    <div
                        ...
                        <div class="con">
                            <span :style="{backgroundColor: index ? bgColorArr[(index-1) % bgColorArr.length] : 'transparent'}" class="topleftcorner"></span><img v-if="0" src="/static/icon/bizinfo_caseindex_thumb.png" class="thumbimg"><img v-else src="/static/icon/bizinfo_caseflow_thumb.png" class="thumbimg">
                        </div>
                    </div>
                </div>
