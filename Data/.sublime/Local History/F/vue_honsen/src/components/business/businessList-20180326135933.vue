    ...
    methods: {
        ...
        getCaseList($state, list, url) {
            ...
            this.$ajax('get', url, params, list.objname + '.loading', (data) => {
                ...
                list.arr = list.arr.concat(dataarr.map(val => { return val;}));
        ...
        onInfiniteLoading($state) {
            ...
            if( this.curBigBigNav == 'cus' ){
                this.getCaseList($state, this.customerlist, this.$apiConfig.bizGroup.getCusList);
            }
        },
        bizSortFn(val, type) {
            this.addparams = {};
