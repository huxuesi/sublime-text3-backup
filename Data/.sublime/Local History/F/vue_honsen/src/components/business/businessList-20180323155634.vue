                ...
                <div class="bizlisthead clearboth">
                        ...
                        <Dropdown :visible="cusNameSearchShow" trigger="custom" class="dropdownnotoppadding" v-clickoutside="closeCusNameSearch">
                            ...
                            <DropdownMenu slot="list">
                                ...
                                <div class="cusnamesearchulwrap" v-scrollUnique>
                                    <p v-for="customer in bizsortdata.customer"><a @click="bizSortFn('customer', customer.ctmid), closeCusNameSearch()" href="javascript:;">{{customer.name}}</a></p>
                                </div>
                            </DropdownMenu>
                        </Dropdown>
                    </div>
                    <div class="headitem creatname">
                        <Dropdown trigger="click" class="dropdown dropdownmaxh290">
                            ...
                            <DropdownMenu slot="list">
                                <DropdownItem v-for="creator in bizsortdata.creator" :key="creator.id">{{creator.name}}</DropdownItem>
                            </DropdownMenu>
                        </Dropdown>
                    </div>
