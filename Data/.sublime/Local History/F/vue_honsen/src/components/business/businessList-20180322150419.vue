        ...
        <Modal
            ...
            <Form :model="casecreateform" :rules="ruleValidate" ref="casecreateform" :label-width="130" class="casecreateform">
                ...
                <FormItem label="案件模板：">
                    ...
                    <div @click="openCreateCaseTpl" class="casecreateformtplval">
                        ...
                        <div v-else>
                            <!-- 1890ff -->
                            <span style="color: #bbbec4;">请选择模板 +</span>
                        </div>
                    </div>
                </FormItem>
            </Form>
            <div class="casecreateformtplvalselect floatpanel">
                ...
                <div class="topnav">
                    ...
                    <a @click="caseModalTplNav = 'gg'" class="nohover" href="javascript:;">公共模板</a>
                </div>
                <div v-if="caseModalTplNav == 'gr'" class="personaltpl">
                    ...
                    <div class="selecttplwrap selectgrtplwrap">
                    ...
                    <div class="selecttplwrap selectggtplwrap">
                        <div v-for="n in 20" class="tplitem">
                            <div class="tplitemtop">
                                <span>进口量将</span>
                                <Radio size="large"></Radio>
