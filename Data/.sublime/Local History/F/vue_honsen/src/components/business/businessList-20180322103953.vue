    ...
    <div class="businesslistwrapv3">
        ...
        <Modal
            ...
            <Form :model="casecreateform" :rules="ruleValidate" ref="casecreateform" :label-width="130" class="casecreateform">
                ...
                <FormItem label="案件模板：">
                    <Input v-model="casecreateform.template" readonly placeholder="请选择案件模板" @on-focus="open_tag_modal">
                    </Input>
                    <div class="casecreateformval">
                        问问问问 <Icon type="android-close"></Icon>
                    </div>
                </FormItem>
            </Form>
            <div slot="footer">
