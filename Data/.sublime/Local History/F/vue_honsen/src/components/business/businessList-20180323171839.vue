    ...
    <div class="businesslistwrapv3">
                        ...
                        <Dropdown :visible="cusNameSearchShow" trigger="custom" class="dropdownnotoppadding" v-clickoutside="closeCusNameSearch">
                            ...
                            <DropdownMenu slot="list">
                                ...
                                <div class="cusnamesearchulwrap" v-scrollUnique>
                                    <p v-for="customer in bizsortdata.customer"><a @click="bizSortFn(customer.ctmid, 'customer'), closeCusNameSearch()" href="javascript:;">{{customer.name}}</a></p>
                                </div>
                            </DropdownMenu>
                        </Dropdown>
                    </div>
        ...
        <Modal
            ...
            <div slot="footer">
                ...
                <Button @click="caseModal = false" type="info" class="gray_btn">取 消</Button>
            </div>
        </Modal>
        ...
        <Modal
            ...
            <div slot="footer">
                ...
                <Button @click="customerModal = false" type="info" class="gray_btn">取 消</Button>
            </div>
        </Modal>
