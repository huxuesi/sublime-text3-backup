                    ...
                    <div class="fujianwrap">
                        ...
                        <ul class="con">
                            <li v-for="n in 10">
                                ...
                                <span>推送</span>
                                <span><img v-if="1" src="/static/icon/bizv2_down_icon.png"><img v-else src="/static/icon/bizv2_down_icon_.png"></span>
                                <span><img v-if="1" src="/static/icon/bizv2_delicon.png"><img v-else src="/static/icon/bizv2_del_icon_.png"></span>
                            </li>
                        </ul>
                    </div>
                    <div class="fujianwrap">
