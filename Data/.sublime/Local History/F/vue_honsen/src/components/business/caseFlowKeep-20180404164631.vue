    ...
    <div class="caseFlowKeep">
        ...
        <div class="conwrap">
            ...
            <div v-else class="casekeepitemwrap">
                <div v-for="casekeep in casekeeplist" class="casekeepitem">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="ckedit">
                                    ...
                                    <span @click="toDelCaseKeep(casekeep)"><img src="/static/icon/bizv2_delicon.png"></span>
...
export default {
    ...
    methods: {
        getFlowKeep() {
            this.$ajax('get', this.$apiConfig.bizGroup.getCaseFlowKeep, (data) => {
            ...
            if( type == 'save' ){
                this.$refs.casekeepcreateform.validate((valid) => {
                    if(valid) {
                        ...
                        if( this.casekeepcreateform.startend ){
