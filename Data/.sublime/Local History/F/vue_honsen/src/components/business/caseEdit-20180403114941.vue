        ...
        <div v-if="curflowobj.casefid" class="caseeditmiddlewrap">
            ...
            <div class="middlecenter">
                <div class="wrap1150">
                    ...
                    <div v-if="curflowobj.casefid != -1" class="intrustinfo">
                        <div class="commoncaseinfohead caseinfohead">
                            <div>
                                <span v-if="!curflowobj.is_editing" class="tit">{{curflowobj.name}}</span>
                                <Input v-else v-model="curflowobj.editname" placeholder="输入流程名称"></Input>
                            </div>
                            <div>
                                ...
                                <span v-if="!curflowobj.is_editing" class="edit">
                                    <Button @click.native="curflowobj.is_editing = true" type="ghost">编 辑</Button>
                                </span>
