...
<template>
    <div class="businesslistwrapv3">
        ...
        <Modal
            ...
            <Form :model="casecreateform" :rules="ruleValidate" ref="casecreateform" :label-width="130" class="casecreateform">
                <FormItem prop="selectid" label="客户归属：">
                    <Input v-model.trim="casecreateform.casename"></Input>
                </FormItem>
                <FormItem prop="casename" label="客户名称：">
                    <Input :maxlength="30" v-model.trim="casecreateform.casename" placeholder="请输入客户名称"></Input>
                </FormItem>
            </Form>
            <div slot="footer">
                <Button type="info">确 定</Button>
...
export default {
    ...
    methods: {
        ...
        // },
        getCaseList() {
            let params = { page: this.caselist.arr / this.caselist.perpage + 1, perpage: this.caselist.perpage};
