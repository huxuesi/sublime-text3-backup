        ...
        <div class="caseinfoformwrap">
            ...
            <div class="formitem2 contact"><span class="itemtit">联系人：</span>
                <span v-if="index < 3" v-for="(cts, index) in contacts" class="commontagwrapspanv2">
                    <Tag :closable="cts.isAuth" @on-close="" :class="{gray:  cts.isCustomerContacts && !cts.isAuth}" class="commontagwrapv2 gray">{{cts.name}}</Tag>
                    <div v-if="cts.isCustomerContacts && !cts.isAuth" class="commontagwrapmaskv2">
                        -
                    </div>
                    <div v-if="cts.isCustomerContacts && !cts.isAuth" class="commontagwrapmaskv2">
                        +
