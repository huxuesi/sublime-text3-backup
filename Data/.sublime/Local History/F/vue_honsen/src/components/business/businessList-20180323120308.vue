    ...
    <div class="businesslistwrapv3">
        ...
        <Modal
            ...
            <Form :model="cuscreateform" :rules="ruleValidate" ref="cuscreateform" :label-width="130" class="casecreateform cuscreateform">
                ...
                <FormItem prop="casename" label="客户名称：">
                    <Input :maxlength="30" v-model.trim="cuscreateform.casename" placeholder="请输入客户名称"></Input>
                </FormItem>
            </Form>
            <div slot="footer">
                <Button type="info">确 定</Button>
    ...
    methods: {
        ...
        AddNewCTM() {
            this.$refs.cuscreateform.validate((valid) => {
                if(valid) {
                    this.$ajax('post', this.$apiConfig.bizGroup.addCustomer.replace((/\{userid\}/, this.cuscreateform.selectid)), { name: this.cuscreateform.name, potential: 0}, (data) => {
