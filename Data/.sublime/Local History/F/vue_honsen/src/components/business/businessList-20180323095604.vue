            ...
            <div v-if="curBigBigNav == 'biz'" class="bizwrap">
                ...
                <div class="bizlistbody">
                    <div v-for="caseitem in caselist.arr" class="bizlistbodyitem">
                        ...
                        <div class="listitem cuslistname"><a href="javascript:;" class="single_ellipsis">{{caseitem.ctmname}}</a></div>
                        <div class="listitem createlistname"><a href="javascript:;" class="single_ellipsis">{{caseitem.creatorname}}</a><!-- <img src="/static/icon/cusgrayhead.png"> --></div>
                        <div class="listitem belonglistname"><a href="javascript:;" class="single_ellipsis">{{caseitem.ctmbelongername}}</a></div>
