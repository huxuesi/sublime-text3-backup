            ...
            <div v-if="curBigBigNav == 'biz'" class="bizwrap">
                ...
                <div class="bizlistbody">
                    <div v-for="caseitem in caselist.arr" class="bizlistbodyitem">
                        <div class="listitem caselistname havereddot"><a @click="$goto({name: 'caseEdit', params: {caseid: caseitem.caseid}})" href="javascript:;" class="single_ellipsis">{{caseitem.casename}}</a></div>
