                ...
                <div class="bizlisthead clearboth">
                    ...
                    <div class="headitem belongname">
                        <Dropdown trigger="click" class="dropdown dropdownmaxh290">
                            ...
                            <DropdownMenu slot="list">
                                <DropdownItem v-for="owner in bizsortdata.owner" :key="owner.id">{{owner.name}}</DropdownItem>
                            </DropdownMenu>
                        </Dropdown>
                    </div>
                    <div class="headitem state">
                        <Dropdown trigger="click" class="dropdown">
                            ...
                            <DropdownMenu slot="list">
                                <DropdownItem v-for="status in bizsortdata.status" :key="status">{{status == 2 ? '未处理' : status == 1 ? '已归档' : '处理中'}}</DropdownItem>
                            </DropdownMenu>
                        </Dropdown>
                    </div>
