    ...
    <div class="businesslistwrapv3">
        ...
        <Modal
            ...
            <Form :model="casecreateform" :rules="ruleValidate" ref="casecreateform" :label-width="130" class="casecreateform">
                ...
                <FormItem label="案件模板：">
                    <Input readonly :placeholder="casecreateform.template ? '' : '请选择模板 +'" @on-focus="" class="casecreateformvalipt">
                    </Input>
                    <div v-if="casecreateform.template" class="casecreateformval">
