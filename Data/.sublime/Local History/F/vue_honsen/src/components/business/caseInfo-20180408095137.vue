        ...
        <div class="caseinfoformwrap">
            ...
            <div class="formitem2 contact"><span class="itemtit">联系人：</span>
                <span v-if="index < 3" v-for="(cts, index) in contacts" class="commontagwrapspanv2">
                    <Tag :closable="!cts.isCustomerContacts" @on-close="" :class="{gray:  cts.isCustomerContacts && !cts.isAuth}" class="commontagwrapv2">{{cts.name}}</Tag>
            ...
            <div class="formitem2 xiezuozhe"><span class="itemtit">协作者：</span>
                <Tag v-if="index < 3" v-for="(cct, index) in coactors" closable @on-close="removeCustomer(cts.id, 'coactor')" :key="cct.cauid"  class="commontagwrapv2">{{cct.name}}</Tag>
                ...
                <Poptip
                    ...
                    <div slot="content">
                        <div class="customer_avatar_item">
                            <Tag v-if="index > 2" v-for="(cts, index) in coactors" closable @click="removeCustomer(cts.id, 'coactor')" :key="cts.ctmctctid"  class="commontagwrapv2">{{cts.name}}</Tag>
                        </div>
                    </div>
                </Poptip>
            ...
            <div class="formitem2 outvisiter"><span class="itemtit">外访者：</span>
                <Tag v-if="index < 3" v-for="(vst, index) in visitors" closable @on-close="removeCustomer(cts.id, 'visitor')" :key="vst.cauid"  class="commontagwrapv2">{{vst.name}}</Tag>
                ...
                <Poptip
                    ...
                    <div slot="content">
                        <div class="customer_avatar_item">
                            <Tag v-if="index > 2" v-for="(cts, index) in visitors" closable @on-close="removeCustomer(cts.id, 'visitor')" :key="cts.ctmctctid"  class="commontagwrapv2">{{cts.name}}</Tag>
                        </div>
                    </div>
                </Poptip>
