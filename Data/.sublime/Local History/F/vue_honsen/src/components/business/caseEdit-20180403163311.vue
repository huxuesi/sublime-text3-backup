...
export default {
    ...
    methods: {
        ...
        getCaseInfo() {
            this.$ajax('get', this.$apiConfig.bizGroup.getCaseInfo.replace(/\{caseid\}/, this.caseInfo.caseid), 'caseloading', data => {
        ...
        createFlow(ischild) {
            this.$ajax('post', this.$apiConfig.bizGroup.addCaseFlow.replace(/\{caseid\}/, this.caseInfo.caseid), {name: ''}, data => {
                let newFlow = {
