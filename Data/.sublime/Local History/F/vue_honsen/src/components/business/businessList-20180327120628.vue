...
export default {
    ...
    methods: {
        ...
        getSettingAuthUsers(users, ids, isNoChange) {
            ...
            console.log(users, ids, isNoChange)

            this.$http.post(this.$apiConfig.bizGroup.setCaseAuth.replace(/\{ctmid\}/, this.SettingAuthCtmid).replace(/\{caseid\}/, this.SettingAuthCaseid), {uids: ids, type: this.SettingAuthType}).then(response => {
