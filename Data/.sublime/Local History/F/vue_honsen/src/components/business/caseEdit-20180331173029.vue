    ...
    <div class="caseeditv2">
                            ...
                            <div>
                                ...
                                <span class="item">
                                    <Poptip v-if="1" v-model="show_clock_panel" class="clock_panel_wrap" placement="bottom" width="300" trigger="click" :transfer="false">
                                        <!-- <div class="clock_icon"><div class="triangle" :class="{active: show_clock_panel}"> -->
        ...
        <div class="caseeditbottomwrap">
            <div class="caseeditbottomcenter clearfix">
                <div v-for="(flowm, index) in aFlows" class="caseeditbottomitemgroup">
                    <!-- 父流程 -->
                    <div :class="{active: index == 0}" class="caseeditbottomitem">
                        <p class="tit">{{flowm.name}}</p>
                    ...
                    <!-- 子流程 -->
                    <div v-for="(subflow, subindex) in flowm.sub_fids" :class="{active: subindex == 0}" class="caseeditbottomitem">
                ...
                <div class="caseeditbottomitemgroup">
