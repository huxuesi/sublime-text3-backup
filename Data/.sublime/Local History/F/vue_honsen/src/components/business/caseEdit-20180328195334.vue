    ...
    <div class="caseeditv2">
        ...
        <div class="caseeditbottomwrap">
            <div class="caseeditbottomcenter">
                <div v-for="n in 12" class="caseeditbottomitem">
                    <p class="tit">案件首页{{n}}</p>
                    <div class="con"><img v-if="n == 1" src="/static/icon/bizinfo_caseindex_thumb.png"><img v-else src="/static/icon/bizinfo_caseflow_thumb.png"></div>
                </div>
            </div>
        </div>
    </div>
