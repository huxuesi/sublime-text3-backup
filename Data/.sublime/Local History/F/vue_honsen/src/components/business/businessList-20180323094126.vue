    ...
    <div class="businesslistwrapv3">
        ...
        <div class="bizlistwrapv3">
            ...
            <div class="bizcuslistpage">
                <infinite-loading @infinite="onInfiniteCaseList" ref="infiniteLoading">
    ...
    methods: {
        ...
        onInfiniteCaseList($state) {
            ...
            this.$ajax('get', this.$apiConfig.bizGroup.getBizList, params, 'caselist.loading', (data) => {
                ...
                this.caselist.arr = this.caselist.arr.concat(data.data.data.map(val => { return val;}));
                if( data.data.data.length < this.caselist.perpage ){
                    $state.complete();
                }else{
                    $state.loaded();
                }
