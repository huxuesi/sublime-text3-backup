    ...
    <div class="case_infov2">
        ...
        <div class="caseinfoformwrap">
            ...
            <div class="formitem2 contact"><span class="itemtit">联系人：</span>
                ...
                <Icon @click.native="openAddmember('contact', '联系人', contacts, false, true)" type="android-add-circle" :class="{hover: 0}" class="addnewiconv2"></Icon>
            </div>
        ...
        <addMemberv2
            ...
            ref="addMemberv2"
            :class="{addmembertop90: SettingAuthType == 'contact', addmembertop137: SettingAuthType == 'coactor', addmembertop178: SettingAuthType == 'visitor'}">
        </addMemberv2>
    </div>
</template>
