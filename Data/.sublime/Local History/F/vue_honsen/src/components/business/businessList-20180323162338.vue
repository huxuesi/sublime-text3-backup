    ...
    <div class="businesslistwrapv3">
            ...
            <div v-if="curBigBigNav == 'biz'" class="bizwrap">
                <div class="bizlisthead clearboth">
                    ...
                    <div class="headitem etime">
                        <div @click="bizSortFn('update_up', 'sortbytime')" class="cursorwrap">编辑时间<div class="triangleiconwrap twoitems"><span class="triangleicontop gray"></span><span class="triangleicondown"></span></div></div>
                    </div>
                    <div class="headitem time">
                        <div @click="bizSortFn('create_up', 'sortbytime')" class="cursorwrap">创建时间<div class="triangleiconwrap twoitems"><span class="triangleicontop"></span><span class="triangleicondown gray"></span></div></div>
                    </div>
        ...
        <Modal
            ...
            <Form :model="cuscreateform" :rules="ruleValidate" ref="cuscreateform" :label-width="130" class="casecreateform cuscreateform">
                <FormItem prop="selectid" label="客户归属：">
                    <Select v-model="cuscreateform.selectid" class="selectselectwrap" placeholder="请选择客户归属">
                        <Option v-for="list in teamOwnerList" :value="list.id" :key="list.id">{{list.name}}</Option>
                    </Select>
                </FormItem>
