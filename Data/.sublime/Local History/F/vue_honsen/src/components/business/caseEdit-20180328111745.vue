                ...
                <div class="wrap1150">
                    <div class="caseinfowrap">
                        ...
                        <div class="caseinfoformwrap">
                            <div class="formitem1 ctmname"><span>客户名称：</span>弘商信息技术（深圳）有限公司</div>
                            <div class="formitem2 contact"><span>联系人：</span>132132132</div>
                            <div class="formitem1 casename"><span>案件名称：</span>案件名称案件名称名称</div>
                            <div class="formitem2 xiezuozhe"><span>协作者：</span>221121221</div>
                            <div class="formitem1 ctmbelong"><span>客户归属：</span>胡小燕</div>
                            <div class="formitem2 outvisiter"><span>外访者：</span>132132132132132</div>
                        </div>
                    </div>
                </div>
            </div>
