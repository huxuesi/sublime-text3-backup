        ...
        <Modal
            ...
            <div class="authsettingitem authsettingedit">
                ...
                <div class="itemwrap">
                    ...
                    <div v-if="!SettingAuthEditUser.length" class="nodatalist" style="padding: 26px 0;">还未添加协作者...</div>
                </div>
            </div>
            <div class="authsettingitem authsettingread">
                ...
                <div class="itemwrap">
                    ...
                    <div v-if="!SettingAuthReadUser.length" class="nodatalist" style="padding: 26px 0;">还未添加外访者...</div>
                </div>
            </div>
            <addMemberv2
