        ...
        <div class="caseeditbottomwrap">
            <div class="caseeditbottomcenter clearfix">
                <div v-for="(flow, index) in aFlows" class="caseeditbottomitemgroup clearfix">
                    <!-- 父流程 -->
                    <div @click="toogleCurflow(flow)" :class="{active: flow.casefid == curflowid, `${bgColorArr[index % 3]}` : true}" class="caseeditbottomitem">
...
export default {
    ...
    data() {
        return {
            caseId: null,
            caseInfo: {},
            bgColorArr: ['bg00a0e9', 'bg9756b7', 'bg13b5b1'],
            aFlows: [],
            curflowid: -1,
            caseloading: false,
