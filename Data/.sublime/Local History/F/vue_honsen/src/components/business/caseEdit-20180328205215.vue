    ...
    <div class="caseeditv2">
        ...
        <div class="caseeditmiddlewrap">
            ...
            <div class="middlebottom">
                <div class="middlebottomitem middlebottomitem1">
                    <div class="bmi1"><img src="/static/icon/bizinfo_middlebottom_icon1.png"></div>
                    <span class="line">|</span>
                    <div class="bmi2"><img src="/static/icon/bizinfo_middlebottom_icon2.png"></div>
                </div>
                <div class="middlebottomitem middlebottomitem2">
                    <div class="bmi3">
                        <Badge dot><img src="/static/icon/bizinfo_middlebottom_icon3.png"></Badge><span class="num">123</span>
                    </div>
                    <span class="line">|</span>
                    <div class="bmi4">
                        <Badge dot><img src="/static/icon/bizinfo_middlebottom_icon4.png"></Badge><span class="num">123</span>
                    </div>
                    <span class="line">|</span>
                    <div class="bmi5">
                        <img src="/static/icon/bizinfo_middlebottom_icon5.png"><span class="num">123</span>
                    </div>
                    <span class="line">|</span>
                    <div class="bmi6">
                        <Badge dot><img src="/static/icon/bizinfo_middlebottom_icon6.png"></Badge><span class="num">123</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="caseeditbottomwrap">
            <div class="caseeditbottomcenter">
                <div v-for="n in 3" class="caseeditbottomitem">
                    <p :class="{active: n == 1}" class="tit">案件首页{{n}}</p>
                    <div :class="{active: n == 1}" class="con"><img v-if="n == 1" src="/static/icon/bizinfo_caseindex_thumb.png" class="thumbimg"><img v-else src="/static/icon/bizinfo_caseflow_thumb.png" class="thumbimg"></div>
                </div>
                <div class="caseeditbottomitem navaddnewflow">
                    <p class="tit"></p>
                    <div class="con">
                        <Icon type="android-add-circle"></Icon>
                        <Button type="info">添加流程</Button>
                    </div>
                </div>
            </div>
        </div>
