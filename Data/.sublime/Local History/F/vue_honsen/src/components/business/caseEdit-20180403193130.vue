                    ...
                    <div class="caseeditbottomitem navaddnewflow">
                        ...
                        <div class="con">
                            ...
                            <div class="btndiv">
                                ...
                                <Button v-if="aFlows.length > 1 && !curflowobj.bigfid" class="btn2" type="ghost">添加子流程</Button>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        createFlow(ischild) {
            ...
            if( ischild ){
                if( !this.curflowobj.bigfid ){
                    return;
                }
                param.parent_fid = this.curflowobj.bigfid;
            }
