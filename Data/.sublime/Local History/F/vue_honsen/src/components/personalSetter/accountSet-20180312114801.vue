...
<template>
    <div class="accountSet">
        ...
        <Row class="wrap infowrap">
            ...
            <Col span="16" class="main">
                <Form :model="form_info" ref="form_info" :rules="form_info_rules" :label-width="95" :key="form_info_key">
...
export default {
    ...
    /*beforeMount() {
        this.form_info_rules.mobile[0].required = this.$authCodeT(this.$store.getters.auth_code_123).isLawyer;
    },*/
    mounted() {
        this.getBindstatus();
        this.get_info();
