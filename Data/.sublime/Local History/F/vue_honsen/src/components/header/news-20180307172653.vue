        ...
        <div class="newsList-wrapper">
            <ul class="newsList">
                <li class="newsItem" v-for="(notif,index) in notifs" :key="index">
                    ...
                    <Badge v-if="notif.type === nType.admin_auth || notif.type === nType.expire_remind" :dot="!notif.is_readed && !isReadNotifs">
                    ...
                    <span class="text" v-if="notif.type === nType.user_evaluate">评价了您，去<a href="javascript:;" @click="$router.push({name: 'personalCenter', params: { id: $store.state.mineInfo.id}})">个人中心</a>查看</span>
                </li >
