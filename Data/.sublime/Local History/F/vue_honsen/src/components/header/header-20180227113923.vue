...
<template>
    <div class="layout_header">
        <Menu v-if="$store.state.loginStatus" mode="horizontal" :theme="'light'" :active-name="init_name" @on-select="navClick" class="menu">
            <li>
                ...
                <div class="popup">
                    ...
                    <ul v-if="recentNotifs.length" v-scrollUnique>
                        <li class="clearfix" v-for="notif in recentNotifs">
                            <div class="img">
                                <Badge v-if="notif.type === nType.admin_auth" :dot="!notif.is_readed">
                            ...
                            <div class="noti_content">
                                ...
                                <!-- 审核的消息 -->
                                <span class="text" v-if="notif.type === nType.admin_auth && notif.detail.result">你的认证审核通过了!</span>
                                <span class="text" v-if="notif.type === nType.admin_auth && !notif.detail.result">你的认证审核没有通过，原因：{{notif.detail.reason}}。请重新去 <a class="content_link" href="javascript:;" @click="toConfirm">认证</a> ！</span>
                                <!-- 日程添加 -->
