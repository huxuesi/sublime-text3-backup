                    ...
                    <ul v-if="recentNotifs.length" v-scrollUnique>
                        <li class="clearfix" v-for="notif in recentNotifs">
                            ...
                            <div class="noti_content">
                                ...
                                <span class="text" v-if="notif.type === nType.user_evaluate">{{notif.detail.a_n}} 评价了您，可去<a href="javascript:;" @click="$router.push({name: 'personalCenter', params: { id: $store.state.mineInfo.id}})" class="content_link"> 个人中心 </a>进行查看</span>
                            </div>
                        </li>
                    </ul>
                    <div class="read_more">
