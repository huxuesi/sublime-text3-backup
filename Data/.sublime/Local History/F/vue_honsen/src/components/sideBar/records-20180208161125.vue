                ...
                <div class="keeprecordtitcont" v-scrollUnique>
                    <div v-for="(list, idx) in curKeeprecords" class="keeprecordtitcontlist">
                        <div class="conthead clearboth">
                            ...
                            <span class="edit"><img title="编辑" src="static/icon/keeprecord_edit_icon.png"><img @click="delkeeprecord(curKeeprecords, idx)" title="删除" src="static/icon/keeprecord_del_icon.png"></span>
                        </div>
                        <div class="contbody">
                            {{list.content}}
                        </div>
