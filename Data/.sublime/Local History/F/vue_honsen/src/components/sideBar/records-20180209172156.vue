    ...
    <div class="side_records">
        <sideBase :haveSideNav="true" ref="sideBase">
            ...
            <div slot="mainTit">
                <div v-if="curKeeprecordsChildId" class="keeprecordtit">
                    ...
                    <div v-else>
                        ...
                        <span class="editicon"><img src="/static/icon/keeprecords_save_icon.png"></span>
                        <span class="editicon"><img src="/static/icon/keeprecords_tpl_icon.png"></span>
                        <span>
            ...
            <div slot="main">
                ...
                <div v-else class="taskcont" v-scrollUnique>
