        ...
        <sideBase :haveSideNav="true" ref="sideBase">
            ...
            <div slot="mainTit">
                <div v-if="curKeeprecordsChildId" class="keeprecordtit">
                    <div v-if="curLeftNav == 'keeprecords'"><Icon v-if="!keeprecordisEditing"  @click.native="toaddkeeprecord" title="添加案件记录" type="android-add-circle"></Icon></div>
                    <div v-else>
                        <Icon @click.native="toaddtask" title="添加案件任务" type="android-add-circle"></Icon>
                    </div>
                </div>
            </div>

            <div slot="main">
                <div v-if="curLeftNav == 'keeprecords'" class="keeprecordtitcont" v-scrollUnique>
