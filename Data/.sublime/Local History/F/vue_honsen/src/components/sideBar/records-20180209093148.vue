...
<template>
    <div class="side_records">
        <sideBase :haveSideNav="true" ref="sideBase">
            ...
            <div slot="mainTit">
                <div :style="{ borderBottom: keeprecordisEditing ? '1px solid #dcdcdc' : ''}" class="keeprecordtit"><Icon v-if="!keeprecordisEditing && curKeeprecordsChildId" @click.native="toaddkeeprecord" title="添加案件记录" type="android-add-circle"></Icon></div>
            </div>
                ...
                <div class="keeprecordtitcont" v-scrollUnique>
                    ...
                    <div v-else>
                        <div class="keeprecordEditForm">
                            ...
                            <div class="keeprecordEditFormsub"><Button @click="submitkeepfrom" type="info" size="large"> 提 交 </Button><Button @click.native="cancelkeeprecordEdit" class="gray_btn" type="info" size="large">取 消</Button></div>
                        </div>
                    </div>
                </div>
            </div>
