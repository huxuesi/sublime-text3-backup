...
<template>
    <div class="side_records">
        <sideBase :haveSideNav="true" ref="sideBase">
            ...
            <div slot="mainTit">
                <div v-if="!keeprecordisEditing && curKeeprecordsChildId" class="keeprecordtit"><Icon @click.native="toaddkeeprecord" title="添加案件记录" type="android-add-circle"></Icon></div>
            </div>
