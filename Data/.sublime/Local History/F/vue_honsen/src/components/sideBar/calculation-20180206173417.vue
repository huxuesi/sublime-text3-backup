    ...
    <div class="calculation">
        <sideBase>
            ...
            <div slot="main">
                ...
                <div v-show="side_type == 'lawyer_fee' && 0" class="lawyer_fee_wrap">
                    <div class="cost_count_wrap">
                    ...
                    <div class="cost_result_wrap">
                        ...
                        <div v-else class="cost_result_content notice_color">
                            {{resLawyerFee}}
                            <span v-show="resLawyerFee" class="notice"> (仅作参考)</span>
                        </div>
