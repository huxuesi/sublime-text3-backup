                    ...
                    <div class="cost_count_wrap">
                        ...
                        <template v-if="curSiteId">
                            <div v-if="curMod == 'ratio'">
                                <Input v-model="ratioMoney" v-onlyNum class="money" type="text" placeholder="标的额（元）"></Input>
                            ...
                            <div v-if="curMod == '1'">
                                <Input class="money" type="text" placeholder="基础费用"></Input>
                                <div>
                                    一审　
                                    <Input class="w130" type="text" placeholder="约定标的"></Input>
                                    　X　
                                    <Input class="w130" type="text" placeholder="比例"></Input>
                                    　%
                                </div>
                            ...
                            <div v-if="curMod == 'time'" class="mt20">
                                <Input v-model="hourly" class="w130" type="text" placeholder="收费标准"></Input>
                                 &nbsp;&nbsp;元/小时&nbsp;&nbsp;&nbsp;&nbsp;
                                <Input v-model="hours" class="w130" type="text" placeholder="工作时数"></Input>
                                &nbsp;&nbsp;小时
                ...
                },
                {
                    ...
                    ratio: {
                        ...
                        fn: (obj) => {
                            ...
                            return `民事诉讼、行政诉讼：${3000 + res1}~${10000 + res1}/件
                            公共利益的群体性诉讼案件：${3000 + res2}~${10000 + res2}/件`;
                        },
                    }
                },
                {
                ...
                },
                {
                    ...
                    ratio: {
                        ...
                        fn: (obj) => {
                            ...
                            let res3 =this.preUitl(obj.ratioMoney, aPres1, 0) * obj.seriousMul;
                            ...
                            let res4 =this.preUitl(obj.ratioMoney, aPres2, 0) * obj.seriousMul;
    ...
    methods: {
        ...
        */
        ...
        getLawsuitRes(type) {
            ...
            if (curItem.input && !this[`lawsuitMoney${type}`]) {
                this.$Modal.warning({
                    title: '计算提示',
                    content: '请先输入金额'
                });
