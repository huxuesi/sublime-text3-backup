...
<template>
    <div class="side_records">
        <sideBase :haveSideNav="true" ref="sideBase">
            ...
            <div slot="mainTit">
                <div :style="{ borderBottom: keeprecordisEditing ? '1px solid #dcdcdc' : ''}" class="keeprecordtit"><Icon @click.native="addkeeprecord" title="添加案件记录" type="android-add-circle"></Icon></div>
            </div>
                ...
                <div class="keeprecordtitcont" v-scrollUnique>
                    ...
                    <div v-else>
                        <div class="keeprecordEditForm">
                            ...
                            <Input v-model.trim="keeprecordEditForm.content" placeholder="输入内容" type="textarea" :rows="14" style="margin-top: 15px"></Input>
