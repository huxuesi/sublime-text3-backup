            ...
            this.$refs.keeprecordEditForm.validate((valid) => {
                if( valid ){
                    if( this.keeprecordEditForm.id ){
                        ...
                        this.$ajax('post', '/record/createrecord', this.keeprecordEditForm, (data) => {
                            this.curKeeprecords.push({ id: data.recordid, title: this.keeprecordEditForm.title, content: this.keeprecordEditForm.content})
                        });
                    }
