            ...
            <div slot="side">
                <div class="keeprecordsnav">
                    ...
                    <div class="keeprecordsnavlistwrap" v-scrollUnique>
                        <Collapse @on-change="changeKeeprecordsNav" v-model="curKeeprecordsNavIdx" class="keeprecordsnavlist" accordion>
