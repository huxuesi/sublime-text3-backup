        ...
        <sideBase :haveSideNav="true" ref="sideBase">
                    ...
                    <div v-else>
                        ...
                        <span class="selecticon">
                            <Select v-model="selecttemId" @on-change="templateChange" class="selectselectwrap" placeholder="选择模板">
                                <Option v-for="tpl in TPL" :value="tpl.id" :key="tpl.id">
                                    {{tpl.template_name}}
            ...
            <div slot="main">
                ...
                <div v-if="curLeftNav == 'keeptasks' && curtasks" class="taskcont" v-scrollUnique>
                    ...
                    <div v-if="showaddtplpanel" class="addtplpanel floatpanel">
                        <div class="addtplpaneltit">保存为任务模板</div>
                        <Input v-model.trim="addtplpanelName" ref="addtplpanelipt" @on-keyup.enter="createTPL" placeholder="给模板命名" class="addtplpanelipt"></Input>
    ...
    methods: {
                ...
                onOk: () => {
                    ...
                    if( curTPL.isget ){
                        ...
                        this.$ajax('get', '/task/tasktemplatedetails', { id: id}, 'keeprecords.listloading', (data) => {
                            this.$set(curTPL, 'content', JSON.parse(data.data.content));
                            let obj = {
        ...
        createTPL() {
            ...
            let obj = {
                ...
                content: JSON.stringify(this.curtasks)
            }
