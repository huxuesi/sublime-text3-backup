        ...
        <sideBase :haveSideNav="true" ref="sideBase">
                    ...
                    <div v-else>
                        ...
                        <span class="selecticon">
                            <Select v-model="selecttemId" @on-change="templateChange" class="selectselectwrap" placeholder="选择模板">
                                <Option v-for="(tpl, i) in TPL" :value="tpl.id" :key="tpl.id">
                                    {{tpl.template_name}}
            ...
            <div slot="main">
                ...
                <div v-if="curLeftNav == 'keeptasks' && curtasks" class="taskcont" v-scrollUnique>
                    ...
                    <div class="addtplpanel floatpanel">
                        <div class="addtplpaneltit">创建流程</div>
                        <Input v-model.trim="flowName" ref="addtplpanelipt" @on-keyup.enter="createParentFlow" placeholder="给模板命名"></Input>
                        <div class="create_flow_panel_btn_wrap">
                            <Button type="info" @click="createParentFlow">提 交</Button>
                            <Button type="info" style="margin-left: 10px" class="gray_btn" @click="showCreateFlowPanel = false">取 消</Button>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        getTPL() {
            this.$ajax('get', '/task/tasktemplatelist', 'keeprecords.listloading', (data) => {
                this.TPL = data.data;
            });
        },
