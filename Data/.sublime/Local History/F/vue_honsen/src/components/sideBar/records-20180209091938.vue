...
<template>
    <div class="side_records">
        <sideBase :haveSideNav="true" ref="sideBase">
            ...
            <div slot="mainTit">
                <div :style="{ borderBottom: keeprecordisEditing ? '1px solid #dcdcdc' : ''}" class="keeprecordtit"><Icon v-if="!keeprecordisEditing" @click.native="toaddkeeprecord" title="添加案件记录" type="android-add-circle"></Icon></div>
            </div>
