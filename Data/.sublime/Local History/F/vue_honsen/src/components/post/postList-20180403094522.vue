        ...
        <div class="right_side">
            <div class="my_post">
                ...
                <contextMenu ref="cid_contextmenu">
                    ...
                    <div class="contextMenu_item" @click.stop="openAuth('edit', 'group')" v-if="handleCategory">编辑授权</div>
                    <div class="contextMenu_item" @click.stop="openAuth('view', 'group')" v-if="handleCategory">阅读授权</div>
                </contextMenu>
...
export default {
    ...
    methods: {
        ...
        setPostAuthtwo(users, ids, isNoChange) {
            ...
            if (this.openAuthType == 'edit') {
                param.type = 'auth_editor';
            } else {
                param.type = 'auth_viewer';
            }
