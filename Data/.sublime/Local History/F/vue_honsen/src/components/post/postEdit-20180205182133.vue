...
<template>
    <div v-if="editable" class="post_edit">
        <Input class="main_tit" type="text" v-model="title" placeholder="请输入文章标题"></Input>

        <Input class="main_tit summary" type="textarea" :rows="3" v-model="summary" placeholder="请输入文章摘要"></Input>
