...
<template>
    <div class="searchresult">
        ...
        <div class="searchrescontent">
            ...
            <div v-if="type == 'user'" class="nodatalist">
                <mt-spinner v-if="user.loading" class="lodingdataicon"></mt-spinner>
                <span v-if="user.isend && !user.loading">没有更多了！</span>
            </div>
            <div v-if="type == 'biz'" class="nodatalist">
                <mt-spinner v-if="biz.loading" class="lodingdataicon"></mt-spinner>
                <span v-if="biz.isend && !biz.loading">没有更多了！</span>
            </div>
        </div>
    </div>
</template>
