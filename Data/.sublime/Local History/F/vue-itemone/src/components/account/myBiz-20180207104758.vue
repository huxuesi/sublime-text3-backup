        ...
        <div class="myBizcontent">
            ...
            <div v-if='allCaseList.person' class="myBizcontentlist appmiddlewrap">
                <div v-if="allCaseList.person.data.length">
                    ...
                    <div class="mybizcaselist">
                        <ul>
                            <li v-for="(list, index) in allCaseList.person.data" @click="goToCaseInfo(list)" class="clearboth"><span class="mybizcaselistname singleellipsis"><i :class="{ red: !list.lawyer}"></i>{{list.casename}}</span><span class="mybizcaseliststate singleellipsis">{{list.lawyer || '未选定'}}</span><span class="mybizcaselisttime">{{list.time | timeconvert}}</span></li>
                        </ul>
                    </div>
                </div>
            </div>
