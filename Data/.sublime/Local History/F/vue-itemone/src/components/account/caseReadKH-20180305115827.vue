                ...
                <div v-for="list in allkeeps" class="flowkeeplist">
                    ...
                    <div class="flowkeeplistcontent">
                        <div class="flowkeeplistcenter">
                            <p class="title"><span class="casename singleellipsis">{{list.flowname}}</span><span class="time">{{list.updated_at | timeconvert}}</span></p>
                            <div class="articlecontent article" v-html="list.content || '未填写跟进记录内容'"></div>
                ...
                <div v-for="list in allflows" class="flowkeeplist">
                    ...
                    <div class="flowkeeplistcontent">
                        <div class="flowkeeplistcenter">
                            ...
                            <div class="articlecontent article" v-html="list.flow.content || '此流程未填写内容'"></div>
                    ...
                    <div v-if="list.keep" class="flowkeeplistcontent">
                        <div class="flowkeeplistcenter">
                            ...
                            <div class="articlecontent article" v-html="list.keep.content ? '案件进展：' + list.keep.content : '未填写跟进记录内容'"></div>
